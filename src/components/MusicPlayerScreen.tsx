      ...
      <div className="max-w-2xl mx-auto space-y-4 sm:space-y-5">
        ...
        <div className="flex items-center justify-between gap-2 border-b border-stone-200/80 pb-3">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-1.5 text-[11px] font-display font-black text-rose-600 uppercase tracking-wider">
              ...
              <span>ONLINE MUSIC STREAMER</span>
            </div>
        ...
        <div className="relative">
          ...
          <input
            ...
            placeholder="Search any song, artist (Arijit, Diljit, Taylor, Kesariya...)"
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto pb-1 scrollbar-none">
          {[
            { id: 'trending', label: '🔥 New Releases' },
            { id: 'bollywood', label: '🌸 Bollywood Comfort' },
        ...
        {/* 3. HERO NOW-PLAYING CARD (Equalizer, Rotating Art, Controls) */}
        <div className="bg-gradient-to-b from-rose-50/70 via-pink-50/40 to-white border border-pink-200/80 rounded-3xl p-5 sm:p-6 shadow-sm space-y-4">
          ...
          <div className="space-y-1 pt-1">
            ...
            <div className="flex justify-between text-[11px] text-stone-500 font-mono font-bold">
              ...
              <span>{formatTime(playerState.duration || 30)}</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between pt-1">
            <div className="flex items-center gap-1">
              <button
                onClick={() => musicStreamingService.setVolume(playerState.volume === 0 ? 0.8 : 0)}
            ...
            <span className="text-xs text-rose-600 font-handwritten font-bold">
              High Quality Audio ✨
            </span>
          </div>
        </div>

        {/* 4. TRACKS FEED / SEARCH RESULTS */}
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <h3 className="font-display font-black text-xs uppercase text-stone-700 tracking-wider">
              {searchQuery ? `Search Results (${searchResults.length})` : 'New Releases & Curated Comfort Playlist:'}
            </h3>
            {isSearching && (
          ...
          {searchResults.length === 0 ? (
            <div className="bg-white border border-dashed border-stone-300 rounded-2xl p-8 text-center space-y-2">
              ...
              <p className="font-handwritten text-xs text-stone-500">Try searching for an artist like "Arijit Singh", "Diljit", or "Bollywood"</p>
            </div>
          ) : (
